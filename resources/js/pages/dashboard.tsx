...
import AuthLayout from "@/components/layouts/authenticated-layout";
        ...
        <>
            ...
            >
                ...
                <div className="mt-8">
                    <PayrollLedgerCard
                        summary={{
                            cutoffLabel: "No payroll run yet",
                            payDate: "—",
                            employeeCount: 0,
                            grossPay: 0,
                            bonuses: 0,
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                    ...
                    <StatCard
                        ...
                        label="Next holiday"
                        value="—"
                        hint="No holiday data available"
                    />
                </div>
                    ...
                    <section className="overflow-hidden rounded-lg border bg-card text-card-foreground lg:col-span-2">
                        <div className="p-6">
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                                Live data from payroll registered and payroll
                                items.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <section className="rounded-lg border bg-card text-card-foreground">
                            <div className="p-6 pb-3">
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">
                                    Philippine holidays from the public holiday
                                    API.
                                </p>
                            </div>
                            <div className="px-6 pb-6 text-sm text-muted-foreground">
